        ...
        <nav className="ml-8 hidden lg:flex gap-1 items-center">
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5">
              Home <ChevronDown className="h-4 w-4 opacity-50 group-hover:rotate-180 transition-transform duration-200" />
            </button>
            <div className="absolute top-full left-0 mt-1 w-48 bg-white dark:bg-[#0a0a0a] border border-slate-200 dark:border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex flex-col p-2 pointer-events-none group-hover:pointer-events-auto">
              {[
                ...
                <a
                  ...
                  className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 flex items-center justify-between"
                >
                  {item.label}
                </a>
              ))}
              ...
              <SheetContent side="right" className="bg-white dark:bg-[#0a0a0a] border-l border-slate-200 dark:border-white/10 p-0 w-[300px]">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-1">
                    {/* Section label */}
                    <p className="text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500 px-3 mb-2">Home Sections</p>
                    {[
                      { label: 'Dashboard', id: '#dashboard' },
                      { label: 'Features', id: '#features' },
                      { label: 'Modules', id: '#modules' },
